...
public final class ClientSettings {
    ...
    public static final ColorSetting NICKNAME_COLOR = new ColorSetting("Nickname Color", 0xFFFFFF);
    public static final ColorSetting ARRAYLIST_COLOR = new ColorSetting("Arraylist Color", 0xFFFFFF);
    ...
    public static Component nicknameComponent() {
        ...
        return Component.literal(NICKNAME.get()).withStyle(s -> s
                .withColor(NICKNAME_COLOR.get() & 0xFFFFFF)
                .withBold(style.bold)
